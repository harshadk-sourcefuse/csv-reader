...
const apiDescription: OperationObject = {
  ...
  "x-codeSamples": [
    {
      lang: "curl",
      source: "curl --location 'https://ksensei-api.sourcef.us/kfintech/v2/mutual-funds?page=1&limit=1&api-key=<INSERT_YOUR_API_KEY>'"
    }, {
      lang: "JavaScript",
      source: "var urlencoded = new URLSearchParams();\n\nvar requestOptions = {\n  method: 'GET',\n  body: urlencoded,\n  redirect: 'follow'\n};\n\nfetch('https://ksensei-api.sourcef.us/kfintech/v2/mutual-funds?page=1&limit=1&api-key=<INSERT_YOUR_API_KEY>', requestOptions)\n  .then(response => response.text())\n  .then(result => console.log(result))\n  .catch(error => console.log('error', error));"
    }, {
      lang: "Node.js",
      source: "const axios = require('axios');\nconst qs = require('qs');\nlet data = qs.stringify({\n   \n});\n\nlet config = {\n  method: 'get',\n  maxBodyLength: Infinity,\n  url: 'https://ksensei-api.sourcef.us/kfintech/v2/mutual-funds?page=1&limit=1&api-key=<INSERT_YOUR_API_KEY>',\n  headers: { },\n  data : data\n};\n\naxios.request(config)\n.then((response) => {\n  console.log(JSON.stringify(response.data));\n})\n.catch((error) => {\n  console.log(error);\n});\n"
    }
  ]
};
/**
